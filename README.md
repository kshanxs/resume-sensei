...
*ATS Optimization · Google X-Y-Z achievements · Typst Engine · Centralized Workspace*

<br>

[![Version](https://img.shields.io/badge/version-1.5.0-8957e5?style=for-the-badge&labelColor=161b22)](./docs/FEATURES.md)
...
*quantifying bullets with Google formulas, scoring job description gaps, and rendering modular Typst layouts.*
...
| 🎨 **Typst Layout System** | Supports clean, grid-aligned Typst layouts with fully custom accent themes |
| 🛡️ **Compilation Safeguards** | Handles Typst syntax constraints (e.g. escaping underscores in text) to guarantee clean compiles |
| 🛠️ **Compiler Helper** | Standalone Python script compiles Typst locally or prints typst.app online compiler instructions |
...
| `"Export this tailored resume to Typst"` | Generates Typst code matching the workspace template layout |
| `"Compile resume [path_to_typ]"` | Compiles Typst source code to a PDF or outputs typst.app online compiler directions |
